# Kong FACEBOOK OAuth JWT Signer
...
summary: generate JWT when a facebook oauth flow is valid  
...
---
plugins:
- name: kong-facebook-oauth-jwt-signer
  config:
    client_id: <empty> # or env var KONG_FACEBOOK_OAUTH_JWT_SIGNER_CLIENT_ID
    client_secret: <empty> # or env var KONG_FACEBOOK_OAUTH_JWT_SIGNER_CLIENT_SECRET
    private_keys: <empty> # private_keys or env var KONG_FACEBOOK_OAUTH_JWT_SIGNER_PRIVATE_KEYS
    # private_keys:
...
Edit `kong.conf` to permit expose environment variable `KONG_FACEBOOK_OAUTH_JWT_SIGNER_PRIVATE_KEYS` to kong:
```conf
nginx_main_env=KONG_FACEBOOK_OAUTH_JWT_SIGNER_PRIVATE_KEYS
```
...
Create the environment variable `KONG_FACEBOOK_OAUTH_JWT_SIGNER_PRIVATE_KEYS` that is a JSON.
Format:  
- key = `kid` of the JWT 
...
Example:
`KONG_FACEBOOK_OAUTH_JWT_SIGNER_PRIVATE_KEYS`
```json
{
  "12345678-1234-1234-1234-123456789ABC":""
}
